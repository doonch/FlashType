...
lessonFiles[lessonFiles.length] = new lesson("LESSON 2: 15-Oct-2013", "lessons/C4.L2.Dan.Jyutping.txt", "Cantonese 4", false, true);
lessonFiles[lessonFiles.length] = new lesson("LESSON 3: 21-Oct-2013", "lessons/C4.L3.Dan.Jyutping.txt", "Cantonese 4", false, true);
lessonFiles[lessonFiles.length] = new lesson("LESSON 4: 19-Nov-2013", "lessons/C4.L4.Dan.Jyutping.txt", "Cantonese 4", false, true);
lessonFiles[lessonFiles.length] = new lesson("LESSON 8: 04-Dec-2013", "lessons/C4.L8.Dan.Jyutping.txt", "Cantonese 4", false, true);
lessonFiles[lessonFiles.length] = new lesson("Video Worksheet 1", "lessons/C4.L3.Video1.Dan.Jyutping.txt", "Cantonese 4", false, true);
lessonFiles[lessonFiles.length] = new lesson("Video Worksheet 2", "lessons/C4.L3.Video2.Dan.Jyutping.txt", "Cantonese 4", false, true);
lessonFiles[lessonFiles.length] = new lesson("LESSON 1: 28-Jan-2014", "lessons/C5.L1.txt", "Cantonese 5", false, true);
lessonFiles[lessonFiles.length] = new lesson("LESSON 2: 4-Feb-2014", "lessons/C5.L2.txt", "Cantonese 5", false, true);
lessonFiles[lessonFiles.length] = new lesson("LESSON 2: class vocabulary", "lessons/C5.L2.class.txt", "Cantonese 5", false, true);
lessonFiles[lessonFiles.length] = new lesson("LESSON 3: 18-Feb-2014", "lessons/C5.L3.txt", "Cantonese 5", false, true);
lessonFiles[lessonFiles.length] = new lesson("LESSON 4: 4-Mar-2014", "lessons/C5.L4.txt", "Cantonese 5", false, true);
lessonFiles[lessonFiles.length] = new lesson("LESSON 5: 11-Mar-2014 Video", "lessons/C5.L5.Video3.txt", "Cantonese 5", false, true);
...
lessonFiles[lessonFiles.length] = new lesson("Lesson 10: easy song", "lessons/Hebrew.10.txt", "Hebrew", false, false);
lessonFiles[lessonFiles.length] = new lesson("Lesson 11: basic vocabulary", "lessons/Hebrew.11.txt", "Hebrew", false, false);
